          ...
          <div className="lg:col-span-2 space-y-6">
            {blogPosts.map((post, i) => (
              <motion.article
                ...
                whileHover={{ y: -3 }}
                className="bg-white rounded-xl overflow-hidden shadow-sm border border-border hover:shadow-md hover:border-vogue/20 transition-all group flex flex-col sm:flex-row"
              >
                <div className="sm:w-1/3 h-48 sm:h-auto bg-ivory overflow-hidden flex-shrink-0">
                  <img
                    src={post.img}
                    alt={post.title}
                ...
                <div className="p-5 flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs bg-cornell/10 text-cornell px-2 py-0.5 rounded-full font-medium flex items-center gap-1">
                  ...
                  <h3 className="font-bold text-cornell mb-2 group-hover:text-vogue transition-colors text-sm leading-snug">
                    {post.title}
                  </h3>
                  <p className="text-xs text-charcoal leading-relaxed mb-3">{post.excerpt}</p>
                  <button className="text-vogue hover:text-cornell text-xs font-semibold flex items-center gap-1 transition-colors">
