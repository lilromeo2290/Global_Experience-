          ...
          <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24">
            ...
            >
              ...
              <p className="text-white/70 max-w-2xl text-lg leading-relaxed">
                Learn about our mission, vision, and the dedicated team behind Global Experience Placements.
                Discover what drives us to connect passionate individuals with transformative opportunities.
              </p>
            </motion.div>
          </div>
        </div>
