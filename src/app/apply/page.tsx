...
const medicalDepartments = [
  'Antiretroviral Therapy (HIV/AIDS Care)',
  'Cardiology',
  'Child Health',
  'Dental Clinic',
  'Dialysis Unit',
  ...
  'Radiology',
  'Surgery (Urology)',
  'Telemetry and Progressive Care Unit (PCU)',
  'Throat',
  'Midwifery',
  'General Nursing',
  'Pediatric',
...
const medicalDepartmentDescriptions: Record<string, string> = {
  'Antiretroviral Therapy (HIV/AIDS Care)': 'Comprehensive HIV/AIDS treatment, counselling, and ongoing care.',
  'Cardiology': 'Diagnosis and treatment of heart and cardiovascular conditions.',
  'Child Health': 'Paediatric care focused on the health and development of children.',
  'Dental Clinic': 'Oral health care including diagnosis, prevention, and treatment.',
  'Dialysis Unit': 'Renal replacement therapy for patients with kidney failure.',
  'Emergency Department (ED)': 'Immediate care for acute illnesses and trauma.',
  'ENT (Ear, Nose & Throat)': 'Diagnosis and treatment of ear, nose, and throat disorders.',
  'Eye Clinic (Ophthalmology)': 'Comprehensive eye care and vision health services.',
  'Family Medicine': 'Primary care for individuals and families across all ages.',
  'Infectious Disease Centre': 'Treatment and management of infectious and communicable diseases.',
  'Intensive Care Unit (ICU)': 'Critical care for patients with life-threatening conditions.',
  'Internal Medicine': 'Management of adult diseases, including specialized cardiovascular, dialysis, and neurological units.',
  'Laboratory Services': 'Diagnostic testing and pathology services.',
  'Medical-Surgical Unit (Med-Surg)': 'Post-surgical and general medical patient care.',
  'Neurology': 'Diagnosis and treatment of nervous system disorders.',
  'Nutrition & Dietetics': 'Nutritional assessment and dietary management.',
  'Obstetrics & Gynecology': 'Maternity care, prenatal services, and women\'s reproductive health.',
  'Oncology': 'Diagnosis and treatment of cancer and tumours.',
  'Ophthalmology': 'Medical and surgical eye care services.',
  'Pediatrics & Child Health': 'Healthcare for infants, children, and adolescents.',
  'Pharmacy': 'Medication dispensing, counselling, and pharmaceutical care.',
  'Physiotherapy & Rehabilitation': 'Physical therapy and rehabilitation services.',
  ...
  'Surgery (Urology)': 'Surgical and urological procedures and care.',
  'Telemetry and Progressive Care Unit (PCU)': 'Monitoring and intermediate care for stable but critical patients.',
  'Throat': 'Specialized care for throat and laryngeal conditions.',
  'Midwifery': 'Prenatal, delivery, and postnatal maternity care.',
  'General Nursing': 'Broad-based nursing care across all clinical areas.',
  'Pediatric': 'Specialized nursing and care for paediatric patients.',
  'Nurse Specialist': 'Advanced practice nursing in specialized clinical areas.',
  'Psychiatric-Mental Health Nurse (PMHN)': 'Mental health and psychiatric nursing care.',
}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        handleChange(e)
                        // Reset medical department when program changes away from Medical
                        if (e.target.value !== 'Medical Placement in Teaching Hospitals') {
                          setFormData(prev => ({ ...prev, medicalDepartment: '' }))
                        }
                      }}
                      className="w-full px-4 py-2.5 rounded-lg border border-border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-cornell/20 focus:border-cornell transition-colors"
                    >
                  ...
                  {/* Medical Department Selection — shown only for Medical Placement */}
                  {formData.program === 'Medical Placement in Teaching Hospitals' && (
                    <div className="sm:col-span-2">
                      <label className="block text-sm font-medium text-charcoal mb-1.5">Medical Department / Unit *</label>
                      <select
                      ...
                      >
                        ...
                        {medicalDepartments.map((dept) => (
                          <option key={dept} value={dept}>
                            {dept}{medicalDepartmentDescriptions[dept] ? ` — ${medicalDepartmentDescriptions[dept]}` : ''}
                          </option>
                        ))}
                      </select>
                      {formData.medicalDepartment && medicalDepartmentDescriptions[formData.medicalDepartment] && (
                        <div className="mt-2 bg-vogue/5 border border-vogue/20 rounded-lg p-3">
                          <p className="text-xs text-charcoal/70">
                            <span className="font-semibold text-vogue">{formData.medicalDepartment}:</span>{' '}
                            {medicalDepartmentDescriptions[formData.medicalDepartment]}
                          </p>
                        </div>
                      )}
                    </div>
