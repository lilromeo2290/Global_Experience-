...
export default function DonatePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#0A1F12]">
      <Navbar />
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-cornell dark:text-white mb-6">
          ...
          >
            <div className="text-center mb-10">
              <h2 className="text-2xl font-bold text-cornell dark:text-white">Outreach Program Areas</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {donationAreas.map((area, i) => (
                ...
                >
                  ...
                  <h3 className="font-bold text-cornell dark:text-white mb-2 text-sm">{area.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-xl font-bold">General Fund</h2>
                </div>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-cornell">Secure Donation Platform</h2>
              </div>
